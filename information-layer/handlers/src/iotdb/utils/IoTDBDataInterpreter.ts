...
export class IoTDBDataInterpreter {
   ...
   */
  static serializeValues(dataTypes: (keyof typeof SupportedMessageDataTypes)[], values: any[]): Buffer {
   ...
   */
  static extractNodesFromTimeseries(obj: Record<string, any>, databaseName: string): Record<string, any> {
